...
/*
        ...
        Copyright 2010 - 2014 D. Bierer <doug@unlikelysource.com>
		Version	1.8.6
		...
		* Modified German translation thanks to Janis Blechert <janis.blechert@gmail.com>
		...
		* Corrected Estonian translation thanks to Kristo Kaupmees <kristo@kpodisain.eu>
		* Added Croatian language thanks to Nikola <kyuzo1@gmail.com>
		* Added Portuguese language thanks to Rui Cabanita <rui@ruicabanita.com>
		* Added a new type "U" on field 8 for customized user-defined fields (i.e. phone numbers)
From: phudak@alphaconsult.sk
i found a bug.
this not works when strictly configured SMTP server requires login to send email.
reason is that any client email adress given as email sender, will cause smtp relay denied, or smtp acces denied errors.

solution is as in native joomla contact componet email form:
-set &quot;sender&quot; from field set in joomla smtp configuration.
-user email inputed in fot set as &quot;reply_to&quot;

look at: /components/com_contact/controllers/contact.php near line 150
...
this works for me:
                ...
                $message-&gt;addRecipient($msg-&gt;to); //adresat z konfigu
//              $message-&gt;setSender($msg-&gt;from); //original value smtp error
                //$message-&gt;setSender($mailfrom);       
                $message-&gt;setSender(array($mailfrom, $fromname));
                $message-&gt;addReplyTo($msg-&gt;from);         
